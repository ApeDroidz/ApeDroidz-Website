// Single source of truth for social/marketplace links.
// Used by the header burger menu, the social sidebar and the footer.
...
export function OpenSeaIcon({ className = "w-5 h-5" }: { className?: string }) {
  // eslint-disable-next-line @next/next/no-img-element
  return <img src="/Opensea.svg" alt="OpenSea" className={className} />
}
...
export const SOCIALS: SocialDef[] = [
  { name: "X", url: X_URL, Icon: XIcon },
  { name: "Discord", url: DISCORD_URL, Icon: DiscordIcon },
  { name: "OpenSea", url: OPENSEA_COLLECTION_URL, Icon: OpenSeaIcon },
]
