            ...
            >
                ...
                <div className="px-2.5 pt-2.5 pb-1 sm:px-3 sm:pt-3 sm:pb-1.5">
                    <p className="text-[8px] sm:text-[12px] md:text-[14px] font-black tracking-[0.08em] uppercase leading-none whitespace-nowrap">
                        <span className="text-white drop-shadow-[0_0_5px_rgba(255,255,255,.2)]">3D Traits</span>{" "}
                        <span className="text-[#3b82f6] drop-shadow-[0_0_8px_rgba(59,130,246,.4)]">is Live in Otherside</span>
                    </p>
                </div>
                ...
                <div className="relative px-1.5 sm:px-1">
                    <div className="relative w-full aspect-[16/7] rounded-xl overflow-hidden bg-[#090909] flex items-center justify-center gap-3 sm:gap-4 md:gap-5 px-4 sm:px-5 md:px-7">
                        ...
                        <img
                            ...
                            alt="Pixel droid"
                            draggable={false}
                            className="h-[82%] aspect-square object-contain flex-shrink-0 rounded-xl"
                        ...
                        {PLACEHOLDER_3D ? (
                            ...
                            <span className="h-[82%] aspect-square flex items-center justify-center flex-shrink-0 rounded-xl text-[13px] sm:text-[15px] md:text-[17px] font-black uppercase tracking-widest text-[#3b82f6] drop-shadow-[0_0_10px_rgba(59,130,246,.5)]">
                                3D
                            </span>
                        )}
                ...
                <div className="flex flex-col gap-1.5 px-2 pb-2 pt-1.5 sm:gap-2 sm:px-3 sm:pb-3 sm:pt-2">
                    <h3 className="text-[15px] sm:text-[19px] md:text-[22px] font-black leading-[0.92] tracking-tight uppercase whitespace-nowrap">
                        <span className="text-white">Choose Your </span>
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-blue-200 to-white">PFP</span>
                    </h3>
