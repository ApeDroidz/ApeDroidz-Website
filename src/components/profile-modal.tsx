                                        ...
                                        <>
                                            ...
                                            <div className="w-full flex flex-col gap-2 lg:gap-3 mt-2 no-capture">
                                                <div className="grid grid-cols-2 gap-2 lg:gap-3">
                                                    ...
                                                    <button onClick={handleDownloadImg} className="cursor-pointer flex items-center justify-center gap-2 py-3 lg:py-4 bg-white/5 text-[#808080] border border-white/10 font-black uppercase tracking-[0.15em] rounded-[20px] lg:rounded-[24px] hover:bg-white/10 hover:text-white transition-all text-[10px] sm:text-xs"><Download size={16} /> Download</button>
                                                </div>
